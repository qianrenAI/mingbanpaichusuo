...
(function() {
  var FAQ = [
    ...
    { q: ['地点','哪里','在哪','位置','地址','颐和路'], a: '我们在南京颐和路街区拍摄，以梧桐大道和民国老洋房为背景，包含歪脖子树等网红机位。具体集合地点预约后摄影师会发给你～' },
    { q: ['风格','什么风格','拍摄风格','日系','复古','胶片'], a: '支持日系清新、复古胶片、自然街拍三种风格，摄影师会根据你的气质推荐最合适的～' },
  ...
  function init() {
    ...
    windowEl.innerHTML =
      ...
      '<div class="chat-quick" id="chatQuick">' +
        ...
        '<button>在哪拍？</button><button>风格？</button>' +
      '</div>' +
